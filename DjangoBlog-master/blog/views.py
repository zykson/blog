...
def fileupload(request):
    ...
    This method requires you to write your own caller to upload the picture, this method only provides the image bed function
    :param request:
    :return:
    """
...
def page_not_found_view(
    ...
    return render(request,
                  template_name,
                  {'message': 'Oops, the address '+ url +' you visited is an unknown place. Please click on the homepage to see others？',
                   'statuscode': '404'},
                  status=404)
