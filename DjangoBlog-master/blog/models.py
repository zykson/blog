...
class Article(BaseModel):
    ...
    pub_time = models.DateTimeField(
        'PublishedTime', blank=False, null=False, default=now)
...
class BlogSettings(models.Model):
    ...
    site_description = models.TextField(
        "that's Vhee personal blog",
        max_length=1000,
        null=False,
        blank=False,
        default='')
    site_seo_description = models.TextField(
        "Site SEO Description", max_length=1000, null=False, blank=False, default='')
    ...
    article_sub_length = models.IntegerField(
        "ArticleSummaryLength", default=300)
    sidebar_article_count = models.IntegerField(
        "NumbOfSidebarArticles", default=10)
    sidebar_comment_count = models.IntegerField(
        "NumbOfSidebarComments", default=5)
    show_google_adsense = models.BooleanField('OpenOrNot', default=False)
    google_adsense_codes = models.TextField(
        'AdContent', max_length=2000, null=True, blank=True, default='')
    open_site_comment = models.BooleanField('OpenOrNot', default=True)
    ...
    def clean(self):
        if BlogSettings.objects.exclude(id=self.id).count():
            raise ValidationError(_('ThereCanOnlyBeOneConfig'))
