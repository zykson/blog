...
def get_blog_setting():
    ...
    if value:
        ...
        if not BlogSettings.objects.count():
            ...
            setting.sitename = 'Vheeblog'
            setting.site_description = "that's Vhee personal blog"
            setting.site_seo_description = "that's Vhee personal blog"
            setting.site_keywords = 'Vhee, Blog'
...
def save_user_avatar(url):
    ...
    try:
        ...
        if rsp.status_code == 200:
            ...
            logger.info('To save the user avatar:' + basepath + savefilename)
